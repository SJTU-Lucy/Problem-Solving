...
{
    bool deleted = false;
    int key[2] = { 0,0 };  // To store 2 dimensional value
    int layer = 0;
    kdNode *left = nullptr;
    kdNode *right = nullptr;
    kdNode(int a, int b, bool flag);
};
...
public:
    ...
    void helper(kdNode* root, int dim);
    ...
    void traverse(vector<kdNode*>& res, kdNode* root, int dim, int lower_bound[], int upper_bound[]);
};
